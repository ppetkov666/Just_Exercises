        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //my temp code
                    //RoleStore<IdentityRole> roleStore = new RoleStore<IdentityRole>(new CarDbContext());
                    //RoleManager<IdentityRole> rolemanager = new RoleManager<IdentityRole>(roleStore);
                    //await rolemanager.CreateAsync(new IdentityRole("CanDeleteRentedTableRecords"));
                    //await UserManager.AddToRoleAsync(user.Id, "CanDeleteRentedTableRecords");
